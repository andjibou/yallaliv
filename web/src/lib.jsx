...
const DICT = {
  fr: {
    ...
    confirm_location: 'Confirmer cette position', locating: 'Recherche de l\u2019adresse…', address_updated: 'Adresse mise à jour 📍', addr_search: 'Rechercher une adresse (rue, quartier, ville)…', addr_no_result: 'Aucune adresse trouvée — placez l\u2019épingle à la main', gmap_title: 'Précision Google Maps', gmap_open: 'Ouvrir Google Maps', gmap_hint: 'Sur Google Maps : posez l\u2019épingle exacte → Partager → Copier le lien → collez-le ci-dessous', gmap_paste: 'Lien partagé Google Maps…', gmap_imported: 'Position Google importée 🎯', gmap_bad_link: 'Lien non reconnu — sur Google Maps : Partager → Copier le lien',
  ...
  ar: {
    ...
    confirm_location: 'تأكيد هذا الموقع', locating: 'جارٍ البحث عن العنوان…', address_updated: 'تم تحديث العنوان 📍', addr_search: 'ابحث عن عنوان (شارع، حي، مدينة)…', addr_no_result: 'لم يتم العثور على العنوان — ضع الدبوس يدويًا', gmap_title: 'دقة خرائط جوجل', gmap_open: 'افتح خرائط جوجل', gmap_hint: 'في خرائط جوجل: ضع الدبوس على المكان بالضبط → مشاركة → نسخ الرابط → الصقه أدناه', gmap_paste: 'رابط مشاركة خرائط جوجل…', gmap_imported: 'تم استيراد الموقع من جوجل 🎯', gmap_bad_link: 'الرابط غير معروف — في خرائط جوجل: مشاركة → نسخ الرابط',
  ...
  en: {
    ...
    confirm_location: 'Confirm this position', locating: 'Locating address…', address_updated: 'Address updated 📍', addr_search: 'Search an address (street, area, city)…', addr_no_result: 'No address found — drop the pin manually', gmap_title: 'Google Maps precision', gmap_open: 'Open Google Maps', gmap_hint: 'In Google Maps: drop the exact pin → Share → Copy link → paste it below', gmap_paste: 'Google Maps share link…', gmap_imported: 'Google position imported 🎯', gmap_bad_link: 'Link not recognized — in Google Maps: Share → Copy link',
