...
const DICT = {
  fr: {
    ...
    hide_listing: 'Masquer', show_listing: 'Afficher', confirm_delete: 'Confirmer la suppression ?',
  ...
  ar: {
    ...
    hide_listing: 'إخفاء', show_listing: 'إظهار', confirm_delete: 'تأكيد الحذف؟',
  ...
  en: {
    ...
    hide_listing: 'Hide', show_listing: 'Show', confirm_delete: 'Confirm deletion?',
