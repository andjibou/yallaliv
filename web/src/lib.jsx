...
const DICT = {
  fr: {
    ...
    confirm_location: 'Confirmer cette position', locating: 'Recherche de l\u2019adresse…', address_updated: 'Adresse mise à jour 📍', addr_search: 'Rechercher une adresse (rue, quartier, ville)…', addr_no_result: 'Aucune adresse trouvée — placez l\u2019épingle à la main',
  ...
  ar: {
    ...
    confirm_location: 'تأكيد هذا الموقع', locating: 'جارٍ البحث عن العنوان…', address_updated: 'تم تحديث العنوان 📍', addr_search: 'ابحث عن عنوان (شارع، حي، مدينة)…', addr_no_result: 'لم يتم العثور على العنوان — ضع الدبوس يدويًا',
  ...
  en: {
    ...
    confirm_location: 'Confirm this position', locating: 'Locating address…', address_updated: 'Address updated 📍', addr_search: 'Search an address (street, area, city)…', addr_no_result: 'No address found — drop the pin manually',
