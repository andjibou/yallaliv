...
const DICT = {
  fr: {
    ...
    orders_nav: 'Commandes', notifications: 'Notifications', settings: 'Paramètres', publish: 'Publier', market: 'Marché', see_all: 'Voir tout',
    my_listings: 'Mes annonces', no_listings: 'Aucune annonce pour le moment', listing_name: "Nom de l'article", listing_desc: 'Description (état, détails…)',
    listing_price: 'Prix', listing_phone: 'Téléphone (affiché aux acheteurs)', listing_cat: 'Catégorie', add_photo: 'Photo (optionnel)',
    no_notifs: 'Aucune notification', mark_all_read: 'Tout marquer lu', push_notifs: 'Notifications push',
    notif_toggle_hint: 'Activez ou coupez les alertes push (cloche)', about: 'À propos',
    sell_hint: 'Vendez vos articles — visibles par tous les utilisateurs de YallaLiv',
    listing_published: 'Annonce publiée 🎉', listing_updated: 'Annonce mise à jour ✓', listing_deleted: 'Annonce supprimée',
    hide_listing: 'Masquer', show_listing: 'Afficher', confirm_delete: 'Confirmer la suppression ?', verify_gmaps: 'Vérifier sur Google Maps',
    sort: 'Trier', sort_recent: 'Plus récentes', sort_price_asc: 'Prix croissant', sort_price_desc: 'Prix décroissant', sort_popular: 'Populaires',
    price_min: 'Prix min', price_max: 'Prix max', apply: 'Appliquer', load_more: 'Charger plus', views: 'vues',
    favorites: 'Favoris', renew: 'Renouveler', renewed: 'Annonce remontée en tête ✓', details: 'Détails',
    brand: 'Marque', size: 'Taille', area_label: 'Quartier / zone', member_since: 'Membre depuis', seller_ads: 'annonces',
    verified: 'Vérifié', safety_tip: "Sécurité : ne payez qu'après avoir vu l'article. Rencontrez le vendeur dans un lieu public.",
    share: 'Partager', link_copied: 'Lien copié ✓', condition_label: 'État', sub_all: 'Tout', step: 'Étape', next: 'Suivant', prev: 'Précédent',
    chat_btn: 'Chat', mk_chats: 'Discussions', mk_none: 'Aucune discussion pour le moment', mk_start: 'Démarrez la conversation',
    mk_q1: 'Encore disponible ?', mk_q2: 'Dernier prix ?', mk_q3: 'Où se rencontrer ?', mk_type: 'Écrivez un message…',
    mk_gps_no: 'GPS indisponible', mk_gps_denied: 'Position refusée — activez le GPS',
    seller_profile: 'Profil du vendeur', leave_review: 'Laisser un avis', review_saved: 'Avis enregistré ✓',
    no_reviews: 'Aucun avis encore', n_reviews: 'avis', total_views: 'Vues totales', ads_count: 'Annonces',
    save_search: 'Sauvegarder cette recherche', search_saved: 'Recherche sauvegardée ✓', saved_searches: 'Recherches sauvegardées',
    sort_near: 'Près de moi', loc_set: 'Position exacte définie ✓', pick_map: 'Définir sur la carte',
    report: 'Signaler', report_q: 'Pourquoi signalez-vous cette annonce ?', r_scam: 'Arnaque / spam', r_prohibited: 'Produit interdit',
    r_price: 'Prix trompeur', r_other: 'Autre', report_sent: 'Signalement envoyé — notre équipe va l’examiner ✓',
    reports_tab: 'Signalements', no_reports: 'Aucun signalement 🎉', reported_by: 'Signalé par', dismiss: 'Ignorer', del_listing: "Supprimer l'annonce",
    deliver_btn: 'Faire livrer par YallaLiv', deliver_title: 'Livraison YallaLiv', deliver_fee: 'Course estimée',
    deliver_pay_note: "Le prix de l'article se règle directement avec le vendeur (cash/Vodafone Cash). Le livreur encaisse uniquement la course.",
    deliver_confirm: 'Commander la livraison', delivery_addr: 'Adresse de livraison', addr_ph: 'ex. : 15 rue Victor Emmanuel, Smouha',
    addr_too_short: 'Adresse trop courte', loc_required: 'Position requise — touchez une proposition 📍', note: 'Note',
    deliver_ok: 'Livraison demandée ! Code PIN :',
    my_sales: 'Mes ventes', no_sales: 'Aucune vente pour le moment', sale_requests: 'Demandes de livraison', course: 'de course',
    accept_sale: 'Accepter', sale_accepted: 'Vente acceptée — un livreur va récupérer l’article ✓', sale_declined: 'Demande déclinée',
    pickup: 'Récupération', pickup_addr: 'Adresse de récupération (chez vous)', pickup_required: 'Définissez le point de récupération 🗺️',
    confirm_sale: 'Confirmer la vente', pickup_hint: 'Le livreur récupère l’article chez vous et le livre à l’acheteur.',
  ...
  ar: {
    ...
    orders_nav: 'الطلبات', notifications: 'الإشعارات', settings: 'الإعدادات', publish: 'نشر', market: 'السوق', see_all: 'عرض الكل',
    my_listings: 'إعلاناتي', no_listings: 'لا توجد إعلانات حتى الآن', listing_name: 'اسم المنتج', listing_desc: 'الوصف (الحالة، التفاصيل…)',
    listing_price: 'السعر', listing_phone: 'الهاتف (يظهر للمشترين)', listing_cat: 'الفئة', add_photo: 'صورة (اختياري)',
    no_notifs: 'لا توجد إشعارات', mark_all_read: 'تعليم الكل كمقروء', push_notifs: 'الإشعارات الفورية',
    notif_toggle_hint: 'شغّل أو أوقف التنبيهات الفورية (الجرس)', about: 'حول',
    sell_hint: 'بِع أغراضك — يراها جميع مستخدمي يلا ليف',
    listing_published: 'تم نشر الإعلان 🎉', listing_updated: 'تم تحديث الإعلان ✓', listing_deleted: 'تم حذف الإعلان',
    hide_listing: 'إخفاء', show_listing: 'إظهار', confirm_delete: 'تأكيد الحذف؟', verify_gmaps: 'تحقق على خرائط جوجل',
    sort: 'ترتيب', sort_recent: 'الأحدث', sort_price_asc: 'السعر: من الأقل', sort_price_desc: 'السعر: من الأعلى', sort_popular: 'الأكثر رواجًا',
    price_min: 'من سعر', price_max: 'إلى سعر', apply: 'تطبيق', load_more: 'تحميل المزيد', views: 'مشاهدة',
    favorites: 'المفضلة', renew: 'تجديد', renewed: 'تم تجديد الإعلان ✓', details: 'التفاصيل',
    brand: 'الماركة', size: 'المقاس', area_label: 'الحي / المنطقة', member_since: 'عضو منذ', seller_ads: 'إعلان',
    verified: 'موثّق', safety_tip: 'السلامة: لا تدفع إلا بعد معاينة المنتج. قابل البائع في مكان عام.',
    share: 'مشاركة', link_copied: 'تم نسخ الرابط ✓', condition_label: 'الحالة', sub_all: 'الكل', step: 'خطوة', next: 'التالي', prev: 'السابق',
    chat_btn: 'محادثة', mk_chats: 'المحادثات', mk_none: 'لا توجد محادثات بعد', mk_start: 'ابدأ المحادثة',
    mk_q1: 'هل لا يزال متاحًا؟', mk_q2: 'آخر سعر؟', mk_q3: 'أين نلتقي؟', mk_type: 'اكتب رسالة…',
    mk_gps_no: 'GPS غير متاح', mk_gps_denied: 'تم رفض الموقع — فعّل GPS',
    seller_profile: 'ملف البائع', leave_review: 'اكتب تقييمًا', review_saved: 'تم حفظ التقييم ✓',
    no_reviews: 'لا تقييمات بعد', n_reviews: 'تقييم', total_views: 'إجمالي المشاهدات', ads_count: 'إعلانات',
    save_search: 'حفظ هذا البحث', search_saved: 'تم حفظ البحث ✓', saved_searches: 'عمليات البحث المحفوظة',
    sort_near: 'الأقرب لي', loc_set: 'تم تحديد الموقع بدقة ✓', pick_map: 'تحديد على الخريطة',
    report: 'إبلاغ', report_q: 'لماذا تبلّغ عن هذا الإعلان؟', r_scam: 'احتيال / سبام', r_prohibited: 'منتج ممنوع',
    r_price: 'سعر مضلل', r_other: 'أخرى', report_sent: 'تم إرسال البلاغ — سيراجعه فريقنا ✓',
    reports_tab: 'البلاغات', no_reports: 'لا بلاغات 🎉', reported_by: 'بلّغ عنه', dismiss: 'تجاهل', del_listing: 'حذف الإعلان',
    deliver_btn: 'توصيل عبر يلا ليف', deliver_title: 'توصيل يلا ليف', deliver_fee: 'التوصيل التقديري',
    deliver_pay_note: 'سعر المنتج يُسوّى مباشرة مع البائع (كاش/فودافون كاش). السائق يحصّل رسوم التوصيل فقط.',
    deliver_confirm: 'اطلب التوصيل', delivery_addr: 'عنوان التوصيل', addr_ph: 'مثال: 15 شارع فيكتور عمانويل، سموحة',
    addr_too_short: 'العنوان قصير جدًا', loc_required: 'الموقع مطلوب — اختر اقتراحًا 📍', note: 'ملاحظة',
    deliver_ok: 'تم طلب التوصيل! رمز التسليم:',
    my_sales: 'مبيعاتي', no_sales: 'لا مبيعات بعد', sale_requests: 'طلبات التوصيل', course: 'توصيل',
    accept_sale: 'قبول', sale_accepted: 'تم قبول البيع — سيأتي السائق لاستلام المنتج ✓', sale_declined: 'تم رفض الطلب',
    pickup: 'الاستلام', pickup_addr: 'عنوان الاستلام (عندك)', pickup_required: 'حدد نقطة الاستلام 🗺️',
    confirm_sale: 'تأكيد البيع', pickup_hint: 'يستلم السائق المنتج من عندك ويوصله للمشتري.',
  ...
  en: {
    ...
    orders_nav: 'Orders', notifications: 'Notifications', settings: 'Settings', publish: 'Post', market: 'Marketplace', see_all: 'See all',
    my_listings: 'My listings', no_listings: 'No listings yet', listing_name: 'Item name', listing_desc: 'Description (condition, details…)',
    listing_price: 'Price', listing_phone: 'Phone (shown to buyers)', listing_cat: 'Category', add_photo: 'Photo (optional)',
    no_notifs: 'No notifications', mark_all_read: 'Mark all read', push_notifs: 'Push notifications',
    notif_toggle_hint: 'Turn push alerts on or off (bell)', about: 'About',
    sell_hint: 'Sell your items — visible to all YallaLiv users',
    listing_published: 'Listing published 🎉', listing_updated: 'Listing updated ✓', listing_deleted: 'Listing deleted',
    hide_listing: 'Hide', show_listing: 'Show', confirm_delete: 'Confirm deletion?', verify_gmaps: 'Check on Google Maps',
    sort: 'Sort', sort_recent: 'Newest', sort_price_asc: 'Price low to high', sort_price_desc: 'Price high to low', sort_popular: 'Popular',
    price_min: 'Min price', price_max: 'Max price', apply: 'Apply', load_more: 'Load more', views: 'views',
    favorites: 'Favorites', renew: 'Renew', renewed: 'Listing bumped to top ✓', details: 'Details',
    brand: 'Brand', size: 'Size', area_label: 'Area / neighbourhood', member_since: 'Member since', seller_ads: 'listings',
    verified: 'Verified', safety_tip: 'Safety: pay only after seeing the item. Meet the seller in a public place.',
    share: 'Share', link_copied: 'Link copied ✓', condition_label: 'Condition', sub_all: 'All', step: 'Step', next: 'Next', prev: 'Back',
    chat_btn: 'Chat', mk_chats: 'Chats', mk_none: 'No conversations yet', mk_start: 'Start the conversation',
    mk_q1: 'Still available?', mk_q2: 'Last price?', mk_q3: 'Where to meet?', mk_type: 'Write a message…',
    mk_gps_no: 'GPS unavailable', mk_gps_denied: 'Location denied — enable GPS',
    seller_profile: 'Seller profile', leave_review: 'Leave a review', review_saved: 'Review saved ✓',
    no_reviews: 'No reviews yet', n_reviews: 'reviews', total_views: 'Total views', ads_count: 'Listings',
    save_search: 'Save this search', search_saved: 'Search saved ✓', saved_searches: 'Saved searches',
    sort_near: 'Near me', loc_set: 'Exact location set ✓', pick_map: 'Set on map',
    report: 'Report', report_q: 'Why are you reporting this listing?', r_scam: 'Scam / spam', r_prohibited: 'Prohibited item',
    r_price: 'Misleading price', r_other: 'Other', report_sent: 'Report sent — our team will review it ✓',
    reports_tab: 'Reports', no_reports: 'No reports 🎉', reported_by: 'Reported by', dismiss: 'Dismiss', del_listing: 'Delete listing',
    deliver_btn: 'Deliver with YallaLiv', deliver_title: 'YallaLiv delivery', deliver_fee: 'Estimated delivery fee',
    deliver_pay_note: 'The item price is settled directly with the seller (cash/Vodafone Cash). The driver only collects the delivery fee.',
    deliver_confirm: 'Request delivery', delivery_addr: 'Delivery address', addr_ph: 'e.g. 15 Victor Emmanuel St., Smouha',
    addr_too_short: 'Address too short', loc_required: 'Location required — pick a suggestion 📍', note: 'Note',
    deliver_ok: 'Delivery requested! PIN code:',
    my_sales: 'My sales', no_sales: 'No sales yet', sale_requests: 'Delivery requests', course: 'fee',
    accept_sale: 'Accept', sale_accepted: 'Sale accepted — a driver will pick up the item ✓', sale_declined: 'Request declined',
    pickup: 'Pickup', pickup_addr: 'Pickup address (your place)', pickup_required: 'Set the pickup point 🗺️',
    confirm_sale: 'Confirm sale', pickup_hint: 'The driver collects the item from you and delivers it to the buyer.',
