...
import { ClientLayout, ClientHome, StorePage, CartPage, ClientOrders, ClientProfile, MarketPage, ListingDetailPage, ChatsPage, ChatPage, SellerProfilePage, SalesPage, PublishPage, NotificationsPage, SettingsPage } from './pages/client.jsx';
        ...
        <AuthProvider>
          <CartProvider>
            <BrowserRouter>
              ...
              <div style={{ position: 'fixed', bottom: 3, right: 8, fontSize: 10, opacity: 0.45, zIndex: 9999, pointerEvents: 'none' }}>YallaLiv v2026.09.26.3</div>
              <Routes>
